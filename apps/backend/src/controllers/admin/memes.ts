...
export const getMemes = async (req: AuthRequest, res: Response) => {
  ...
  const memes = rows.map((r) => ({
    ...
    fileUrl: (r.memeAsset.playFileUrl ?? r.memeAsset.fileUrl) ?? null,
...
export const updateMeme = async (req: AuthRequest, res: Response) => {
  ...
  try {
    ...
    res.json({
      ...
      fileUrl: ((updated.memeAsset as any).playFileUrl ?? updated.memeAsset.fileUrl) ?? null,
...
export const deleteMeme = async (req: AuthRequest, res: Response) => {
  ...
  try {
    ...
    res.json({
      ...
      fileUrl: ((deleted.memeAsset as any).playFileUrl ?? deleted.memeAsset.fileUrl) ?? null,
