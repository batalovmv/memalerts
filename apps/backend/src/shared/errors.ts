...
export const ERROR_CODES = {
  ...
  MEME_COOLDOWN_ACTIVE: 'MEME_COOLDOWN_ACTIVE',
  ...
  BONUS_UNAVAILABLE: 'BONUS_UNAVAILABLE',
  BONUS_COOLDOWN: 'BONUS_COOLDOWN',
  BONUS_LIMIT_REACHED: 'BONUS_LIMIT_REACHED',
  BONUS_OFFLINE: 'BONUS_OFFLINE',
...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  USER_SPAM_BANNED: 'You are temporarily banned from submissions',
  ...
  MEME_COOLDOWN_ACTIVE: 'Meme cooldown active',
  ...
  BONUS_UNAVAILABLE: 'Bonus is unavailable',
  BONUS_COOLDOWN: 'Bonus cooldown active',
  BONUS_LIMIT_REACHED: 'Bonus limit reached',
  BONUS_OFFLINE: 'Bonus is available only while the stream is live',
...
export const ERROR_MESSAGES_RU: Record<ErrorCode, string> = {
  ...
  BETA_ACCESS_REQUIRED: 'Нужен доступ к бете',
  CSRF_INVALID: 'Ошибка проверки CSRF',
  NOT_FOUND: 'Не найдено',
  CHANNEL_NOT_FOUND: 'Канал не найден',
  CONFLICT: 'Конфликт',
  TOO_MANY_REQUESTS: 'Слишком много запросов',
  ALREADY_IN_CHANNEL: 'Этот мем уже в вашем канале',
  MISSING_CHANNEL_ID: 'Отсутствует channelId',
  TWITCH_BOT_NOT_CONFIGURED: 'Twitch-бот не настроен',
  YOUTUBE_RELINK_REQUIRED: 'Требуется повторная привязка YouTube',
  YOUTUBE_CHANNEL_REQUIRED: 'Требуется канал YouTube',
  YOUTUBE_API_NOT_CONFIGURED: 'YouTube API не настроен',
  YOUTUBE_API_QUOTA: 'Квота YouTube API исчерпана',
  YOUTUBE_BOT_NOT_CONFIGURED: 'YouTube-бот не настроен',
  YOUTUBE_ENABLE_FAILED: 'Не удалось включить YouTube-бота',
  VKVIDEO_BOT_NOT_CONFIGURED: 'VKVideo-бот не настроен',
  STREAMER_SUBMISSIONS_DISABLED: 'Отправка мемов отключена для этого канала',
  ONLY_WHEN_LIVE: 'Отправка мемов разрешена только во время стрима',
  SUBMISSIONS_DISABLED: 'Отправка мемов отключена для этого канала',
  SUBMISSIONS_OFFLINE: 'Отправка мемов разрешена только во время стрима',
  USER_SPAM_BANNED: 'Вы временно заблокированы за спам',
  SUBMISSION_NOT_FOUND: 'Отправка не найдена',
  SUBMISSION_NOT_PENDING: 'Отправка не в статусе ожидания',
  MEME_NOT_FOUND: 'Мем не найден',
  CHANNEL_MEME_NOT_FOUND: 'Мем не найден',
  MEME_ASSET_NOT_FOUND: 'Файл мема не найден',
  MEME_COOLDOWN_ACTIVE: 'Мем временно на кулдауне',
  INVALID_TITLE: 'Некорректный заголовок',
  INVALID_MEDIA_URL: 'Некорректный URL медиа',
  INVALID_MEDIA_TYPE: 'Некорректный тип медиа',
  UPLOAD_TIMEOUT: 'Загрузка превысила время ожидания',
  FILE_TOO_LARGE: 'Файл слишком большой',
  VIDEO_TOO_LONG: 'Видео слишком длинное',
  UPLOAD_FAILED: 'Не удалось загрузить файл',
  MEDIA_NOT_AVAILABLE: 'Медиа недоступно',
  ASSET_PURGED_OR_QUARANTINED: 'Файл удален или на карантине',
  INVALID_FILE_TYPE: 'Недопустимый тип файла',
  INVALID_FILE_CONTENT: 'Недопустимое содержимое файла',
  TRANSCODE_FAILED: 'Не удалось перекодировать медиа',
  RATE_LIMITED: 'Слишком много запросов',
  TIMEOUT: 'Время ожидания истекло',
  TWITCH_CHANNEL_NOT_LINKED: 'Twitch-канал не привязан',
  TWITCH_ACCOUNT_MISMATCH: 'Несовпадение аккаунта Twitch',
  TWITCH_ELIGIBILITY_UNKNOWN: 'Не удалось определить доступность награды Twitch',
  TWITCH_REWARD_NOT_AVAILABLE: 'Награда Twitch недоступна',
  TWITCH_ELIGIBILITY_CHECK_FAILED: 'Не удалось проверить доступность награды Twitch',
  REWARD_COST_COINS_REQUIRED: 'Нужны стоимость награды и количество монет',
  REWARD_DISABLED_OFFLINE: 'Награда отключена вне стрима',
  BONUS_UNAVAILABLE: 'Бонус недоступен',
  BONUS_COOLDOWN: 'Бонус на кулдауне',
  BONUS_LIMIT_REACHED: 'Лимит бонуса исчерпан',
  BONUS_OFFLINE: 'Бонус доступен только во время стрима',
  OAUTH_FAILED: 'Ошибка OAuth',
  OAUTH_STATE_MISMATCH: 'Несовпадение состояния OAuth',
  TWITCH_NOT_LINKED: 'Twitch-аккаунт не привязан',
  TWITCH_ALREADY_LINKED: 'Twitch-аккаунт уже привязан',
  ACCOUNT_ALREADY_LINKED: 'Аккаунт уже привязан',
  BOT_NOT_CONFIGURED: 'Бот не настроен',
  BOT_DISABLED: 'Бот отключен',
  RELAY_UNAVAILABLE: 'Релей недоступен',
