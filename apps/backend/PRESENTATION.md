...
MemAlerts — backend для сервиса “мемы на стриме”: зрители активируют мемы за внутреннюю валюту/поинты, а стример получает **OBS overlay** (мем‑оверлей) и **панель управления**.
