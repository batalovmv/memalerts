        ...
        <div className="mt-3 space-y-4">
          ...
          <div className="relative">
            ...
            {overlaySettingsSavedPulse && !savingOverlaySettings && !loadingOverlaySettings && (
              <SavedOverlay label={t('admin.saved')} />
            )}
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-gray-600 dark:text-gray-300">
                      {overlayMode === 'queue'
                        ...
                        : t('admin.obsOverlayModeUnlimitedHint', {
                            defaultValue: 'Shows all incoming memes at once (no limit).',
                          })}
                    </div>
                  </div>
              ...
              <div className="glass p-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <HelpTooltip
                      content={t('help.settings.obs.resetDefaults', {
                        defaultValue: 'Reset all overlay appearance settings back to defaults.',
                      })}
                    >
                      <Button
                        type="button"
